...
public class TextMemo_Text extends Activity {
    ...
    public class check_update extends AsyncTask<Void, Void, Void>{
		...
		protected Void doInBackground(Void... params) {
			// TODO Auto-generated method stub
				...
				String url = "http://manpowermgmt.igexsolutions.com/ws/textpicturememo.php?" +"mode="+"insert"
                        +"&memocode="+"m002"
                        +"&hqid="+Hqid
                        +"&memotype="+"txt"
                        +"&lat="+latitude
                        +"&lon="+longitude
                        +"&memodetails="+Memo.getText().toString().trim();
    	...
    	protected void onPreExecute() {
    		// TODO Auto-generated method stub
    		super.onPreExecute();
    		progressDialog = ProgressDialog.show(TextMemo_Text.this, "", "Loading..!!", true);
		...
		protected void onPostExecute(Void result) {
			...
			if(count==2)
			{
				Toast.makeText(TextMemo_Text.this, "Insert successful..", Toast.LENGTH_SHORT).show();
			}
			else if(count==3)
			{
				Toast.makeText(TextMemo_Text.this, "Error in Inserting..!!", Toast.LENGTH_SHORT).show();
			}
